"use client"
import { BriefcaseBusiness, Contact, Home, Moon, Sun, UserRound, Wrench, FolderKanban } from 'lucide-react';
...
export default function DockBar() {
    ...
    const items = [
        ...
        { icon: <BriefcaseBusiness size={16} color={color} />, label: 'Experience', onClick: () => scrollToSection('experience') },
        { icon: <FolderKanban size={16} color={color} />, label: 'Projects', onClick: () => scrollToSection('projects') },
