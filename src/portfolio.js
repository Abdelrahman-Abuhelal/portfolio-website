...
const greeting = {
  username: "Abdelrahman Abuhelal",
  title: "Hi all, I'm Abdelrahman",
  subTitle: emoji(
    "A passionate Backend Developer 🚀 having wide experience of building Secure Web applications with Spring boot / Reactjs and some other cool libraries and frameworks."
  ),
  resumeLink:
    "https://docs.google.com/document/d/1wyfRV3vjNi-SoAJdXvTja1q3KBXa7PBA3x890_CAfRs/edit?usp=sharing", // Set to empty to hide the button
...
const socialMediaLinks = {
  github: "https://github.com/Abdelrahman-Abuhelal",
  linkedin: "https://www.linkedin.com/in/abdelrahman-abuhelal/",
...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "Al-Quds University",
      logo: require("./assets/images/alquds.png"),
    ...
    {
      schoolName: "Mälardalens University",
  ...
  experience: [
    {
      ...
      companylogo: require("./assets/images/exalt1.png"),
      date: "January 2021 – Present",
      desc: "Gained big experience in different fields during my college time at that company.",
      descBullets: [
        "Implementing RESTful APIs using Spring boot and Security",
        "Working with Hibernate ORM and MySQL database",
        "Writing Unit tests using Mockito framework"
      ]
    },
    {
      role: "AI Solution Developer Intern",
      company: "Bosch Softawre Campus",
...
const contactInfo = {
  ...
  number: "+972-598062832",
  email_address: "abd.hilal14@gmail.com"
};
